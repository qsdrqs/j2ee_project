				...
				<section class="content">
					...
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title"
								style="align-content: center; font-family: 'Courier New', Monospace">经纪人列表</h3>
						</div>
						<input type="hidden" name="houseId" value="${param.id}" /> 
						<div class="box-body">
							<!-- 数据表格 -->
							<div class="table-box">
								<!--数据列表-->
								<table id="dataList"
									...
									<tbody>
										<c:forEach items="${requestScope.pi.list }" var="agent">
											<tr>
												<td><input type="radio" name="agentId"
													value="${agent.agentId}" >${agent.agentId}</td>
									...
									<div class="box-footer">
										...
										<div class="box-tools pull-right">
											<ul class="pagination">
												<li><a href="../house/allow.do?id=${param.id}&p=1">首页</a></li>
												<c:if test="${pi.hasPreviousPage }">
													<li><a
														href="../house/allow.do?id=${param.id}&p=${pi.pageNum-1}"
												...
												<c:forEach items="${pi.navigatepageNums }" var="page_Num">
													...
													<c:if test="${page_Num != pi.pageNum }">
														<li><a
															href="../house/allow.do?id=${param.id}&p=${page_Num }">${page_Num }</a></li>
													</c:if>
												...
												<li><a
													href="../house/allow.do?id=${param.id}&p=${pi.pages}">末页</a></li>
											</ul>
										</div>
									</div>
									<!--订单信息/-->
