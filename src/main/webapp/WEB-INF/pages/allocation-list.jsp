	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li><a href="../main.do"><i class="fa fa-dashboard"></i>
							首页</a></li>
					<li><a href="#">数据管理</a></li>
			...
			<section class="content">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title"
							style="align-content: center; font-family: 'Courier New', Monospace">房源信息列表</h3>
					</div>
					...
					<div class="box-body">
						...
						<div class="table-box">
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="刷新"
											onclick="location.href='../house/allowcation.do'">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										<th class="sorting_asc">房源ID</th>
										<th class="sorting_desc">户主ID</th>
										<th class="sorting_desc">地址</th>
										<th class="sorting_desc ">均价</th>
										<th class="sorting">面积</th>
										<th class="text-center sorting">楼层</th>
										<th class="sorting">有无电梯</th>
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs"
													onclick="location.href='../house/allow.do?id=${house.houseId}'">分配</button>
												<button type="button" class="btn bg-olive btn-xs"
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="../house/allowcation.do?p=1">首页</a></li>
								<c:if test="${pi.hasPreviousPage }">
									<li><a
										href="../house/allowcation.do?p=${pi.pageNum-1}"
								...
								<c:forEach items="${pi.navigatepageNums }" var="page_Num">
									...
									<c:if test="${page_Num != pi.pageNum }">
										<li><a
											href="../house/allowcation.do?p=${page_Num }">${page_Num }</a></li>
									</c:if>
								...
								<li><a href="../house/allowcation.do?p=${pi.pages}">末页</a></li>
							</ul>
						</div>
					</div>
					<!-- /.box-footer-->
