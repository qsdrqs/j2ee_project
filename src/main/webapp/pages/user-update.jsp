...
<body>
	<form action="/user/update" method="post">
		...
		用户性别:<input type ="radio" ${(user.userSex eq 1) ? ' checked=checked ' :'' } name="userSex" value="1" />男 
				<input type ="radio" ${(user.userSex eq 0) ? ' checked=checked ' :'' } name="userSex" value="0" />女<br /> 
